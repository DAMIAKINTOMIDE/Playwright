...
Playwright UI Automation Technical Assessment (Javascript)
Overview
This take-home assessment evaluates your proficiency with Playwright for UI automation testing. You'll be creating automated tests for a public website, implementing various testing techniques, and demonstrating best practices in test architecture.
Requirements
Setup (10%)
Set up a new Playwright project with Javascript
Configure the necessary dependencies
Implement a basic project structure following testing best practices
Test Scenarios (50%)
Implement automated tests for https://automationexercise.com with the following scenarios:
...
API Integration: Combine UI tests with API calls for test setup or verification. The site offers a list of available APIs at https://automationexercise.com/api_list that can be used for this purpose.
